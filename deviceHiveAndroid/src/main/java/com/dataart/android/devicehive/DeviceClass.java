...
public class DeviceClass extends DataContainer {
     ...
     * @param isPermanent    Whether this device class is permanent.
     * @param offlineTimeout If set, specifies inactivity timeout in seconds before the
